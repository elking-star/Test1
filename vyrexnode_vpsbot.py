...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('vyrexnode_bot.log'),
...
DB_FILE = 'vyrexnode.db'
BACKUP_FILE = 'vyrexnode_backup.pkl'
...
async def setup_container(container_id, status_msg, memory, username, vps_id=None, use_custom_image=False):
    ...
    try:
        ...
        if isinstance(status_msg, discord.Interaction):
            await status_msg.followup.send("✅ LasheenHosting VPS setup completed successfully!", ephemeral=True)
        else:
            await status_msg.edit(content="✅ LasheenHosting VPS setup completed successfully!")
...
async def show_commands(ctx):
    ...
    try:
        embed = discord.Embed(title="🤖 LasheenHosting VPS Bot Commands", color=discord.Color.blue())
...
async def create_vps_command(ctx, memory: int, cpu: int, disk: int, owner: discord.Member, 
    ...
    try:
        ...
        status_msg = await ctx.send("🚀 Creating LasheenHosting VPS instance... This may take a few minutes.")
        ...
        if use_custom_image:
            ...
            try:
                container = bot.docker_client.containers.run(
                    ...
                    detach=True,
                    privileged=True,
                    hostname=f"lasheenhosting-{vps_id}",
                    ...
                    volumes={
                        f'lasheenhosting-{vps_id}': {'bind': '/data', 'mode': 'rw'}
                    },
        ...
        try:
            embed = discord.Embed(title="🎉 LasheenHosting VPS Creation Successful", color=discord.Color.green())
...
async def list_vps(ctx):
    ...
    try:
        ...
        embed = discord.Embed(title="Your LasheenHosting VPS Instances", color=discord.Color.blue())
...
async def admin_list_vps(ctx):
    ...
    try:
        ...
        embed = discord.Embed(title="All LasheenHosting VPS Instances", color=discord.Color.blue())
        valid_vps_count = 0
...
async def delete_vps(ctx, vps_id: str):
    ...
    try:
        ...
        await ctx.send(f"✅ LasheenHosting VPS {vps_id} has been deleted successfully!")
    except Exception as e:
...
async def connect_vps(ctx, token: str):
    ...
    try:
        ...
        embed = discord.Embed(title="LasheenHosting VPS Connection Details", color=discord.Color.blue())
...
async def admin_stats(ctx):
    ...
    try:
        ...
        embed = discord.Embed(title="LasheenHosting System Statistics", color=discord.Color.blue())
...
async def vps_usage(ctx):
    ...
    try:
        ...
        embed = discord.Embed(title="Your LasheenHosting VPS Usage", color=discord.Color.blue())
...
async def global_stats(ctx):
    ...
    try:
        ...
        embed = discord.Emembed(title="LasheenHosting Global Usage Statistics", color=discord.Color.blue())
...
async def reinstall_bot(ctx):
    ...
    try:
        await ctx.send("🔄 Reinstalling LasheenHosting bot... This may take a few minutes.")
...
class VPSManagementView(ui.View):
    ...
    async def handle_missing_container(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(title=f"LasheenHosting VPS Management - {self.vps_id}", color=discord.Color.red())
    ...
    async def start_vps(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            embed = discord.Embed(title=f"LasheenHosting VPS Management - {self.vps_id}", color=discord.Color.green())
            ...
            await interaction.followup.send("✅ LasheenHosting VPS started successfully!", ephemeral=True)
        except Exception as e:
    ...
    async def stop_vps(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            embed = discord.Emembed(title=f"LasheenHosting VPS Management - {self.vps_id}", color=discord.Color.orange())
            ...
            await interaction.message.edit(embed=embed)
            await interaction.followup.send("✅ LasheenHosting VPS stopped successfully!", ephemeral=True)
        except Exception as e:
    ...
    async def restart_vps(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            if token:
                ...
                try:
                    ...
                    if ssh_session_line:
                        ...
                        try:
                            owner = await bot.fetch_user(int(vps["created_by"]))
                            embed = discord.Embed(title=f"LasheenHosting VPS Restarted - {self.vps_id}", color=discord.Color.blue())
            ...
            await interaction.followup.send("✅ LasheenHosting VPS restarted successfully! New SSH details sent to owner.", ephemeral=True)
        except Exception as e:
...
class OSSelectionView(ui.View):
    ...
    async def reinstall_os(self, interaction: discord.Interaction, image: str):
        try:
            ...
            status_msg = await interaction.followup.send("🔄 Reinstalling LasheenHosting VPS... This may take a few minutes.", ephemeral=True)
            ...
            try:
                container = bot.docker_client.containers.run(
                    ...
                    detach=True,
                    privileged=True,
                    hostname=f"lasheenhosting-{self.vps_id}",
                    mem_limit=memory_bytes,
                    cpu_period=100000,
                    ...
                    network=DOCKER_NETWORK,
                    volumes={
                        f'lasheenhosting-{self.vps_id}': {'bind': '/data', 'mode': 'rw'}
                    }
                )
            except docker.errors.ImageNotFound:
            ...
            try:
                ...
                if ssh_session_line:
                    ...
                    try:
                        owner = await bot.fetch_user(int(vps["created_by"]))
                        embed = discord.Embed(title=f"LasheenHosting VPS Reinstalled - {self.vps_id}", color=discord.Color.blue())
            ...
            await status_msg.edit(content="✅ LasheenHosting VPS reinstalled successfully!")
...
class TransferVPSModal(ui.Modal, title='Transfer VPS'):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            await interaction.response.send_message(f"✅ LasheenHosting VPS {self.vps_id} has been transferred from {old_owner_name} to {new_owner_name}!", ephemeral=True)
...
async def manage_vps(ctx, vps_id: str):
    ...
    try:
        ...
        embed = discord.Embed(title=f"LasheenHosting VPS Management - {vps_id}", color=discord.Color.blue())
